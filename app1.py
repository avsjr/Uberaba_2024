...
def index():
    ...
    if request.method == 'POST':
        ...
        for idx, row in gdf.iterrows():
            ...
            region_leader = request.form[f'region{region_number}_leader']
            ...
            <p style="margin: 10px; font-size: 12px; font-weight: bold;">Região {region_number}:</span>
                <ul style="list-style-type: none; padding: 10;">
                    ...
                    <li>Liderança: {'Elisa' if elisa_percentage > tony_percentage else 'Tony' if tony_percentage > elisa_percentage else 'Empate'}</li>
                </ul>
            </p>
                '''
        ...
        m.get_root().html.add_child(folium.Element(legend2_html))  # Add this line to fix the issue
        # Salva o mapa interativo como um arquivo HTML
